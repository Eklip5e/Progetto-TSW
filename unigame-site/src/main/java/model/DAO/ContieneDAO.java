...
public class ContieneDAO implements model.DAO.MetodiDAO<Contiene> {
    ...
    public void doSave(Contiene contiene) {
        try (Connection con = ConPool.getConnection()) {
            ...
            ps.setDate(4, new java.sql.Date(contiene.getDataInserimento().getTime()));
    ...
    public void doUpdate(Contiene contiene, int id) {
        try (Connection con = ConPool.getConnection()) {
            ...
            ps.setDate(2, new java.sql.Date(contiene.getDataInserimento().getTime()));
